...
class Curl {
    ...
    // Send a get request on its way with optional parameters (and get output)
    ...
    // Send a put request on its way with optional parameters (and get output)
    // $url = '', $params = array(), $options = array()
